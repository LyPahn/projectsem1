                ...
                <div class="row no-gutters">
                    ...
                    <div class="col-md-4">
                        <div class="breadcrumb">
                            <div class="breadcrumb-item"><i class="fas fa-angle-right"></i><a
                                    href="{{ route('account.index') }}">Danh sách</a>
                            </div>
                    ...
                    <div class="hotel-listing-form">
                        <form class="text-center" role="form" method="POST" enctype="multipart/form-data"
                            ...
                            <div class="form-row">
                                <div class="col-md">
                                    <div class="form-group">
                                        <label for="inputGroupSelect07" class="">Tên tài khoản</label>
                                        <input type="text" class="form-control"  id="inputGroupSelect07"
                                            name="name">
                                        @error('name')
                            ...
                            <div class="form-row">
                                <div class="col-md">
                                    <div class="form-group">
                                        <label for="inputGroupSelect07" class="">Mật khẩu</label>
                                        <input type="password" class="form-control"  id="inputGroupSelect07"
                                            name="password">
                                        @error('password')
                                            <span class="text-danger">{{ $message }}</span>
                                        @enderror
                                ...
                                <div class="col-md">
                                    <div class="form-group">
                                        <label for="inputGroupSelect07" class="">Xác thực mật khẩu</label>
                                        <input type="password" class="form-control"  id="inputGroupSelect07"
                                            name="Rpassword">
                                        @error('Rpassword')
                            ...
                            <ul class="list-inline">
                                ...
                                <li class="list-inline-item">
                                    <button class="btn"><a href="{{ route('account.index') }}"
