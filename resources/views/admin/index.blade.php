			...
			<div class="content dashbaord">
				<div class="in-content-wrapper">
					...
					<div class="box">
						...
						<div class="content booking-content dashboard-bookings m-0">
							<div class="in-content-wrapper">
								<div class="row no-gutters">
										...
										<div class="col">
											<table id="example" class="display table-hover table-responsive-xl">
												...
												<tbody>
													...
													<tr>
														<td><img src="{{asset('assets')}}/images/commenter-1.jpg" alt="table-img"
													...
													<tr>
														<td><img src="{{asset('assets')}}/images/commenter-2.jpg" alt="table-img"
																class="img-fluid rounded-circle" width="40px"></td>
														<td>Hunn dan</td>
														<td><a href="#">933334442</a></td>
														<td><a href="#">dan@gmail.com</a></td>
														<td>4/06/2019</td>
														<td>7/06/2019</td>
														<td>Tour</td>
														<td class="approved"><a href="#">Approved</a></td>
													...
													<tr>
														<td><img src="{{asset('assets')}}/images/commenter-3.jpg" alt="table-img"
						...
						<div class="box dashbaord-reviews">
							...
							<div class="reviews-body">
								<ul>
									<li>
										<div class="media">
											<img src="{{asset('assets')}}/images/commenter-2.jpg" class="mr-1 mr-sm-3 rounded-circle"
												alt="...">
