					...
					<div class="room-details__left">
						...
						<div class="mt-40">
							...
							<div class="row room-facility-list mb-40">
								...
								<div class="col-sm-6 col-xl-4">
									<div class="list-one d-flex align-items-center me-sm-4 mb-3">
										<div class="icon text-theme-color1 mr-10 flex-shrink-0"><i class="far fa-swimming-pool"></i></div>
								...
								<div class="col-sm-6 col-xl-4">
									<div class="list-one d-flex align-items-center me-sm-4 mb-3">
										<div class="icon text-theme-color1 mr-10 flex-shrink-0"><i class="far fa-shield-check"></i></div>
						...
						<div class="p-4 p-lg-5 bg-light">
							...
							<form id="contact_form" name="contact_form" class="" action="https://kodesolution.com/html/2023/hoexr-html/includes/sendmail.php" method="post">
								<div class="row">
									<div class="col-sm-6 col-xl-4">
										<div class="mb-3">
				...
				<div class="col-xl-4 col-lg-5">
					<div class="sidebar">
						<div class="sidebar__post mb-30">
							<form id="contact_form2" name="contact_form" class="" action="https://kodesolution.com/html/2023/hoexr-html/includes/sendmail.php" method="post">
								<div class="row">
									<div class="col-sm-12">
										<div class="mb-3">
                                            <label class="form-label">Check In</label>
                                                <input name="form_name" class="form-control bg-white" type="date" placeholder="Arrive Date">
                                            </div>
									</div>
									<div class="col-sm-12">
										<div class="mb-3">
						...
						<div class="sidebar__single sidebar__post">
							...
							<ul class="sidebar__post-list list-unstyled">
								<li>
									<div class="sidebar__post-image"> <img src="{{asset('fe')}}/images/resource/news-info-1.jpg" alt=""> </div>
									<div class="sidebar__post-content">
										<h3> <span class="sidebar__post-content-meta"><i class="far fa-door-open"></i>Economy Room</span> <a href="#">$175/Night</a>
										</h3>
									</div>
								</li>
								<li>
									<div class="sidebar__post-image"> <img src="{{asset('fe')}}/images/resource/news-info-2.jpg" alt=""> </div>
									<div class="sidebar__post-content">
										<h3> <span class="sidebar__post-content-meta"><i class="far fa-door-open"></i>Deluxe Room</span> <a href="#">$250</a> </h3>
									</div>
								</li>
								<li>
									<div class="sidebar__post-image"> <img src="{{asset('fe')}}/images/resource/news-info-1.jpg" alt=""> </div>
									<div class="sidebar__post-content">
										<h3> <span class="sidebar__post-content-meta"><i class="far fa-door-open"></i>Super Deluxe Room</span> <a href="#">$320</a> </h3>
									</div>
								</li>
							</ul>
						</div>
...
<script src="{{asset('fe')}}/js/bxslider.js"></script>
...
<script src="{{asset('fe')}}/js/jquery.form.min.js"></script>
<script>
(function($) {
